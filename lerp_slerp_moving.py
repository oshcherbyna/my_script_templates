...
CU = bpy.data.objects['Cube'] # додати на сцену
SU = bpy.data.objects['Suzanne'] # додати на сцену

def obj_move_to_target(obj1, obj2, rot_speed = 0.1, move_speed = 0.01, distance = 0.1):
    '''
     Рух та орієнтація обʼєкта у 3D-просторі за 
     допомогою лінійної та сферичної інтерполяції векторів.
      ...
      obj2: обʼєкт-ціль, до якої рухається обʼєкт
      rot_speed: швидкість обертання
      move_speed: швидкість руху
      distance: дистанція наближення до цілі
    '''
